...
class Post(models.Model):
    ...
    # It requires a title, a unique slug
    # and the name of the mod-maker if applicable
    # The users name is displayed as is the date
    #  and time the post was created
    # Content provides a textfield for the main body of the post
    # A status setting referances the above constant
    # and defines publication status
    # The excerpt allows users to view a short
    # excerpt of the content without clicking the post
    ...
    # The __str__ method allows the blog titles to
    # be read with an indication of content
    def __str__(self):
...
class Comment(models.Model):
    ...
    # The __str__ method allows the comments
    # to be read with an indication of content
    def __str__(self):
