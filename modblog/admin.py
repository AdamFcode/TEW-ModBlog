...
class PostAdmin(SummernoteModelAdmin):
    ...
    # Prepopulated fields helps automatically
    # populate the slug with title content
    # Summernote fields provides summernote
    # functionality for greater editor features
